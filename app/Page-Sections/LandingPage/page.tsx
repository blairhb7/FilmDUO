...
const page = () => {
  return (
    ...
    <main className="  lg:h-screen grid grid-cols-1 lg:grid-cols-4 w-screen gap-3 p-6   bg-[#141414] overflow-hidden">
        <section className=" lg:col-span-3 flex justify-end items-end rounded-xl h-[500px] lg:h-full overflow-hidden">
          <h1 className=" absolute  z-40 xl:text-5xl p-10  text-white flex  font-extrabold uppercase">YOUR CINEMATIC VISION, OUR CREATIVE EXPERTISE.</h1>
