...
const ContactForm = () => {
  ...
  return (
    <form  onSubmit={sendEmail} ref={form}  method='POST' className=' border  border-[#efe7d271] rounded-xl py-2 px-3 2xl:mx-[5%] justify-center gap-3 '  >
        <div className="flex justify-center gap-5 ">
            <div className=' w-full'>
                ...
                <input className='w-full bg-[#141414] border  border-[#efe7d271] rounded-xl px-3'
                placeholder='Name'
                type="text"
                name='name'
      ...
      <div className="flex py-6 justify-center ">
        <div className=' flex flex-col w-full'>
            ...
            required
            ></textarea>
            <input type="submit" value="Send"  className=' border-gray-300 w-full h-20 cursor-pointer uppercase py-6 bg-[#141414] hover:text-white duration-500 text-4xl font-headline' />
        </div>
